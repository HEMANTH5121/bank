    ...
    if (($amount)<0)
   {
    ...
    // constraint to check zero values
         ...
         echo "</script>";
                ...
                $sender = $sql1['name'];
                $receiver = $sql2['name'];
                $sql = "INSERT INTO transaction(`sender`, `receiver`, `balance`)
                VALUES ('$sender','$receiver','$amount')";


            
                if($query)echo "<script> alert('Hurray! Transaction is Successful');
...
<link rel="stylesheet" href="css/style.css">
	...
	<div class="container" style="padding:6rem" >
        ...
        <br>
            ...
            <button class="btn mt-3" name="submit" type="submit" id="myBtn" style="background-color : black;">Transfer Money</button>
            </div>
        </form>
    </div>
